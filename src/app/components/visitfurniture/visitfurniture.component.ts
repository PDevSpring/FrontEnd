...
@Component({
  selector: 'app-visitfurniture',
  templateUrl: './visitfurniture.component.html',
  styleUrls: ['./visitfurniture.component.css']
})
export class VisitfurnitureComponent implements OnInit {
